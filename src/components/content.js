        ...
        <div style={styles.horizontal}>
            <div style={styles.left}>
                <div style={styles.textContainer}>
                    ...
                    React, while on the back-end, I am proficient in Node.js, Express,
                    and MongoDB. I am also developing my mobile skills using React
                    Native to ensure seamless integration between front-end and
                    back-end operations.
                    </p>
                </div>
            </div>
