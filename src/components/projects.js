  ...
  return (
    ...
    <div className="projectsContainer" style={styles.projectsContainer}>
      <div className="project">
        <img src={gradsapp} style={styles.project}></img>
        <a>
          <p style={styles.projectParagraph}>
            <div>
              ...
              <p>
                ...
                networking, resource sharing, and collaboration. Key technical
                features include:
              </p>
              <br />
              <ul>
      ...
      {/* grads website */}
      <div className="project">
        <a href="https://paulooliveira152012.github.io/grads/" target="_blank">
          <img src={gradsweb} style={styles.project}></img>
        </a>
        <p style={styles.projectParagraph}>
          <div>
            <p>
            ...
            <p>
              The Grads app website is a showcase platform, designed to promote
              the Grads app and attract students to download and join this
              supportive community. Created with HTML, CSS, JavaScript,
              Bootstrap, and jQuery, this visually appealing website highlights
              the app's core features, encouraging students to explore and
              engage.
            </p>
            <br />
            <ul>
      ...
      <div className="project">
        ...
        <p style={styles.projectParagraph}>
          ...
          Necessitatibus aut iste, temporibus et veritatis reiciendis non earum,
          corrupti quod, sapiente minus dolorum? Quisquam in suscipit
          praesentium alias? Similique, ipsa debitis. Lorem ipsum dolor, sit
          amet consectetur adipisicing elit. Necessitatibus aut iste, temporibus
          et veritatis reiciendis non earum, corrupti quod, sapiente minus
          dolorum? Quisquam in suscipit praesentium alias? Similique, ipsa
          debitis.
        </p>
      </div>
